...
Version 1.0 · 24 août 2026 · Auteur : D. Dambreville · **Domaine public (CC0 1.0)**
...
- un **tableau de bord HTML autonome** : registre des projets, neuf indicateurs à seuils, journal des décisions, suivi du sas — sans serveur, sans dépendance, hors ligne.
...
Une seule réunion obligatoire : la **revue hebdomadaire** (30–60 min), qui exécute les gestes ② à ⑤.

## Commencer

1. Lire la **[notice d'utilisation](7-exploitation/2026-08-24_7_notice-utilisation_v1.0.0.md)** — installation en 15 minutes.
2. Ouvrir **[le tableau de bord](5-conception/2026-08-24_5_tableau-de-bord-praxis_v1.0.0.html)** dans un navigateur (télécharger le fichier, double-cliquer, puis l'enregistrer sous son nom d'usage `tableau_de_bord.html`).
3. Lire la **[méthode intégrale](5-conception/2026-08-24_5_methode-praxis_v1.0.0.md)** ([PDF](5-conception/2026-08-24_5_methode-praxis_v1.0.0.pdf)) pour la doctrine, les règles et les annexes.
...
| | tableau-de-bord-praxis (html) | Le tableau de bord autonome (nom d'usage : `tableau_de_bord.html`) |
